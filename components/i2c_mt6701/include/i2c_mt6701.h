...
void mt6701_dir_write(i2c_master_dev_handle_t dev_handle, double value);
...
void mt6701_hyst_write_raw(i2c_master_dev_handle_t dev_handle, uint16_t value);
...
void mt6701_z_pulse_width_write_raw(i2c_master_dev_handle_t dev_handle, uint16_t value);
...
void mt6701_zero_write_raw(i2c_master_dev_handle_t dev_handle, uint16_t value);
...
void mt6701_pwm_freq_write_raw(i2c_master_dev_handle_t dev_handle, uint16_t value);
...
void mt6701_a_stop_write_raw(i2c_master_dev_handle_t dev_handle, uint16_t value);
...
void mt6701_a_start_write_raw(i2c_master_dev_handle_t dev_handle, uint16_t value);
