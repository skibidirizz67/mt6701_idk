...
uint8_t mt6701_uvw_mux_read_raw(i2c_master_dev_handle_t dev_handle) {
...
// 0x0 UVW
// 0x1 -A-B-Z
void mt6701_uvw_mux_write_raw(i2c_master_dev_handle_t dev_handle, uint8_t value) {
    uint8_t reg_addr = 0x25;
    uint8_t buff[2] = {0};
...
void mt6701_zero_write(i2c_master_dev_handle_t dev_handle, double value) {
    ...
    buff[0] = reg_addr;
    // DDDDXXXX DDDDDDDD
    buff[1] = (buff[1] & 0x3F) | (uint8_t)((code << 4) & 0xF0);
